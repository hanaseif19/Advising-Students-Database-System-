...
{
    public partial class CoursesPrerequisites : System.Web.UI.Page
    {
        ...
        {
            coursepreq.Rows.Clear();
            coursepreq.Rows.Add(CreateHeaderRow(resultTable));
            foreach (DataRow row in resultTable.Rows)
            {
                coursepreq.Rows.Add(CreateRow(row, resultTable.Columns));
            }
        }
