...
{
    public partial class Courses_Slots_Instructors : System.Web.UI.Page
    {
        ...
        {
            courseslotinsTable.Rows.Clear();
            courseslotinsTable.Rows.Add(CreateHeaderRow(resultTable));
            foreach (DataRow row in resultTable.Rows)
            {
                courseslotinsTable.Rows.Add(CreateRow(row, resultTable.Columns));
            }
        }
